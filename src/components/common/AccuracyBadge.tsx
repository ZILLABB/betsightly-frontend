...
export function AccuracyBadge({ compact = false }: { compact?: boolean }) {
  ...
  // Only slips produced by the current engine count here. The earlier chain
  // was generated by a model that has since been replaced wholesale, and
  // headlining its record would describe a system that no longer exists —
  // the same misrepresentation as hiding a bad run, pointed the other way.
  // Nothing is deleted: the Results page still shows every day, won or lost.
